...
public class PaypalService {
    ...
    // Permite comunicarse con API Externas
    ...
    // Configuracion de tokens que Paypal exige para accerder a sus endpoints
    ...
    public OrderResponse createOrder(Long reservationId, String returnUrl, String cancelUrl) {
        ...
        // Envio de toda la info a la API de Paypal
